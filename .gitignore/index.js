...
bot.on("guildMemberAdd", function(member) {
    member.guild.channels.find("name", "nouveaux").sendMessage(member.toString() + " Bienvenue sur le discord de **Diversion** ! :white_check_mark:");
...
bot.login('NDM2Mjc1MzIwMTIzOTQ5MDY4.Db0fpw.j9ZUIC8gim0PcPhT700lOJ6h5HA');
